...
日线来自 Yahoo Finance Chart API；具体标的覆盖范围、数据来源、拆股口径可在游戏内「规则与数据说明」查看。历史行情已内置，运行时不请求第三方行情或字体。市场观察采用自托管中英文字体、清晰的报价卡片与响应式图表；可用分区导航快速前往行情、宏观日历或交易委托，账户和回放不会因此改变。字体许可与来源见 `fonts/README.md`。
